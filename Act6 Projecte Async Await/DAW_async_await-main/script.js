...
const keys = {
    api_key: 'f6ce764df61c7fb0f29fd19237064986',
    session_id: '477a8205233c4be7886a11a0b31391dd0af6e950',
    //Para conseguir el session_id hay que Conseguir un request token y luego ponerlo en la url de la siguiente manera:
    //https://www.themoviedb.org/authenticate/{request_token}, despues hay que ir al postman y poner en el body el request token
    //y el apikey en la authentication para poder hacer los ejercicios por que caducan cada hora
    account_id: '21215425'
